...
import { s_runSimulator, s_pauseSimulator, s_stopSimulator, s_setTime, s_executeCode } from 'actions/simulatorActions';
...
function* simulatorHandler() {
  ...
  yield take([s_pauseSimulator.type, s_stopSimulator.type, s_setTime.type, s_runSimulator.type]);
  yield cancel(task);
}
